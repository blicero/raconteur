...
# Time-stamp: <2022-06-20 19:36:40 krylon>
#
...
* Clock
  ...
  #+CAPTION: Clock summary at [2022-06-20 Mo 19:36]
  | Headline                   | Time       |           |       |      |
  |----------------------------+------------+-----------+-------+------|
  | *Total time*               | *2d 23:09* |           |       |      |
  |----------------------------+------------+-----------+-------+------|
  | *Moving parts*             | *2d 23:09* |           |       |      |
  | \_  /Data types/           |            | /2:40/    |       |      |
  | \_  /Database/             |            | /7:25/    |       |      |
  | \_  /Scanner/              |            | /7:07/    |       |      |
  | \_    Metadata             |            |           |  5:17 |      |
  | \_      Monitor Folders    |            |           |       | 1:47 |
  | \_  /GUI/                  |            | /2d 5:57/ |       |      |
  | \_    Playback             |            |           | 14:48 |      |
  | \_    TreeView             |            |           |  9:09 |      |
...
*** TODO Playback
    :LOGBOOK:
    CLOCK: [2022-06-18 Sa 18:06]--[2022-06-18 Sa 20:30] =>  2:24
